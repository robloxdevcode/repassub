    ...
    <>
      ...
      <div className="max-w-3xl mx-auto">
        <AppPageHeader
          ...
          subtitle={
            hasUnlocks
              ? "Overview of your link views and unlocks."
              : "Create a link that unlocks after subscribe, follow, or join."
          }
        />
        ...
        {!hasUnlocks && (
          <section className="dash-empty mb-10">
            ...
            <p className="mt-2 text-sm text-retro-text-dim max-w-sm mx-auto leading-relaxed">
              Add your content, choose a fan action, and share one link. Use{" "}
        ...
        {hasUnlocks && (
          <>
            <Link href="/analytics" prefetch className="dash-metrics block mb-8 group">
              ...
              <span className="dash-metrics-hint group-hover:text-retro-text">
                View all stats
            ...
            <section>
              <div className="flex items-center justify-between mb-4">
                ...
                <Link
                  href="/unlocks"
                  prefetch
                  className="text-xs font-medium text-retro-text-muted hover:text-retro-text transition-colors"
                >
                  See all
                </Link>
              </div>
        ...
        {!isPro && hasUnlocks && (
          <p className="mt-10 text-center text-sm text-retro-text-muted">
            ...
            <Link href="/billing" prefetch className="font-medium text-retro-text hover:underline">
              View plans
            </Link>
          </p>
        )}
